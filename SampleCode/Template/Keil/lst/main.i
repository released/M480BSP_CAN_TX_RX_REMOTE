...
void CAN_IRQHandler(CAN_T *tCAN)
{
    ...
    if(u8IIDRstatus == 0x00008000)         
    {
        ...
        if(tCAN->STATUS & (0x1ul << (6)))
        {
            printf("EWARN INT\n") ;
        }

        if(tCAN->STATUS & (0x1ul << (7)))
        {
            printf("BOFF INT\n") ;
...
void (CAN0_IRQHandler)(void)
{
	...
	CAN_IRQHandler((((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x60000UL))));
...
{
    if(CAN_SetRxMsg(tCAN, ((16)),0ul, (0x401)) == (0UL))
    {
        printf("Set Rx Msg Object failed\n");
        return;
    }

    if(CAN_SetRxMsg(tCAN, ((17)),1ul, (0xF504)) == (0UL))
    {
        printf("Set Rx Msg Object failed\n");
        return;
    }

    if(CAN_SetRxMsg_Remote(tCAN, ((18)) ,0ul, (0x601)) == (0UL))
    {
        printf("Set Rx Msg Object failed\n");
        return;
    }

	if(CAN_SetRxMsg_Remote(tCAN, ((19)) ,1ul, (0xFAEE)) == (0UL))
    {
        printf("Set Rx Msg Object failed\n");
        return;
    }
	...
	CAN_EnableInt(tCAN, (0x1ul << (1)) | (0x1ul << (2)));
...
void DEVICE_SetTxMsg_Remote_Frame(CAN_T *tCAN)
{
	...
	if(CAN_Transmit(tCAN, ((20)),&tMsg) == (0UL))   
	{
	...
	if(CAN_Transmit(tCAN, ((21)),&tMsg) == (0UL))   
	{
		printf("Set Tx Msg Object failed\n");
		return;
	}	
...
void DEVICE_Tx(CAN_T *tCAN)
{
    ...
    tMsg.IdType   = 0ul;
    tMsg.Id       = (0x301);
    tMsg.DLC      = strlen((char*) can_data_00);	
	for ( i = 0 ; i < 5 ; i++)
	{
    ...
    if(CAN_Transmit(tCAN, ((22)),&tMsg) == (0UL)) 
    {
        printf("Set Tx Msg Object failed\n");
        return;
    }
    ...
    if(CAN_Transmit(tCAN, ((23)),&tMsg) == (0UL))
    {
        printf("Set Tx Msg Object failed\n");
        return;
    }
...
void CAN_Setup(void)
{
    DEVICE_SetRxMsg((((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x60000UL))));

    DEVICE_Tx((((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x60000UL))));
       
	DEVICE_SetTxMsg_Remote_Frame((((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x60000UL))));

}

void RS_PIN_Init(void)   
{
	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((2)<<2)))) = 0;
	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((3)<<2)))) = 0;

	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL & ~((0xful << (8)))) | ((0x00UL<<(8)));
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL & ~((0xful << (12)))) | ((0x00UL<<(12)));
...
void CAN_Init(void)
{
    CAN_Open((((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x60000UL))),  500000, 0ul);
}
