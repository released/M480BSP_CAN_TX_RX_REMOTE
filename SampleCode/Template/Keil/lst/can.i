...
#line 10 "..\\..\\..\\Library\\StdDriver\\src\\can.c"
...
#line 43 "..\\..\\..\\Library\\StdDriver\\src\\can.c"
...
int32_t CAN_ReadMsgObj(CAN_T *tCAN, uint8_t u8MsgObj, uint8_t u8Release, STR_CANMSG_T* pCanMsg)
{
    int32_t rev = 1l;
    uint32_t u32MsgIfNum;
    uint32_t u32TimeOutCount = SystemCoreClock * 2; 
...
int32_t CAN_SetRxMsg_Remote(CAN_T *tCAN, uint32_t u32MsgNum, uint32_t u32IDType, uint32_t u32ID)
{
    ...
    while(CAN_SetRxMsgObj_Remote(tCAN, (uint8_t)u32MsgNum, (uint8_t)u32IDType, u32ID, (uint8_t)(1UL)) == (int32_t)(0UL))
    {
        if(++u32TimeOutCount >= (0x10000000ul))
        {
            rev = (int32_t)((0UL));  
